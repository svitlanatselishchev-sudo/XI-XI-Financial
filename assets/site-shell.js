(function(){
  ...
  var mobile=document.createElement('nav');mobile.id='site-mobile-menu';mobile.className='mobile-menu';mobile.setAttribute('aria-label','Mobile navigation');mobile.setAttribute('aria-hidden','true');
  ...
  var css=document.createElement('link');css.rel='stylesheet';css.href='assets/share.css?v=2';document.head.appendChild(css);
  var script=document.createElement('script');script.src='assets/share.js?v=2';script.defer=true;document.head.appendChild(script);
})();
